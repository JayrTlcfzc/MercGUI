...
const SearchSubscriber = () => {
  ...
  const handleSubmitDate = async () => {
    ...
    console.log("Response from retailersCollection:", res);
    setLoading(true);
    if (res.success) {
      toast.success(res.message || t("success_download_retailers"));
    ...
    <div className="min-h-screen bg-gray-200 p-8">
      ...
      <div className="p-6 bg-white shadow-md rounded-lg">
        <h2 className="text-2xl font-bold text-gray-800 flex items-center justify-center mb-8">
          <FaMagnifyingGlass className="text-blue-500 mr-2" />
          {t("search_subscriber")}
        </h2>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          >
            <option value="1">{t("account_id")}</option>
            <option value="2">{t("msisdn")}</option>
            <option value="3">{t("agent_code")}</option>
          </select>
          ...
          <button
            ...
            className="md:w-1/3 px-6 py-2 tracking-wide shadow-md rounded font-bold bg-blue-500 text-white hover:bg-indigo-600"
          >
            {t("search")}
          </button>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          <button
            className="md:w-1/3 px-6 tracking-wide shadow-md rounded font-bold py-2 bg-blue-500 text-white hover:bg-indigo-600"
